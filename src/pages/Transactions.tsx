...
export default function Transactions() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Filters */}
      <section className="py-4 sm:py-6 border-y border-border/30 bg-background/95 sticky top-[72px] sm:top-20 z-30 backdrop-blur-md">
        <div className="container mx-auto px-4 md:px-6 max-w-6xl">
            ...
            {divisions.map((division) => {
              ...
              return (
                <button
                  ...
                  className={`inline-flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full text-xs sm:text-sm font-light transition-all whitespace-nowrap flex-shrink-0 ${
                    isActive 
