    ...
    return (
      <div className="min-h-screen pb-24 md:pb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
          {/* Header */}
          <div className="mb-8">
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-extralight text-foreground mb-2">Calendar</h1>
    ...
    <div className="min-h-screen pb-24 md:pb-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
          <div>
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-extralight text-foreground mb-2">Calendar</h1>
            <p className="text-muted-foreground font-light">Your Google Calendar events</p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 glass-card p-4 md:p-6">
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <h2 className="text-xl font-light">{format(currentMonth, "MMMM yyyy")}</h2>
              ...
              <div className="grid grid-cols-7 gap-1">
                {calendarDays.map((day) => {
                  ...
                  return (
                    ...
                    >
                      <span className={cn("text-sm font-medium", isTodayDate && !isSelected && "text-primary")}>
                        {format(day, "d")}
                      </span>
                      {dayEvents.length > 0 && (
