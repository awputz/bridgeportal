...
export default function Home() {
  ...
  return <div className="min-h-screen">
      ...
      <section className="py-16 md:py-24 lg:py-32 border-b border-white/5">
        <div className="container mx-auto px-4 md:px-6 max-w-6xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            }].map(step => <div key={step.num} className="p-6 border-l-2 border-accent/30 rounded-lg bg-white/[0.02] hover:bg-white/[0.04] transition-all duration-400">
      ...
      {recentTransactions.length > 0 && <section className="py-16 md:py-24 lg:py-32 border-b border-white/5">
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
              {recentTransactions.map(transaction => <div key={transaction.id} className="p-4 md:p-6 rounded-lg transition-all duration-400 hover:bg-white/3 border-l-2 border-transparent hover:border-accent/30 hover:transform hover:-translate-y-1">
      ...
      <section className="py-16 md:py-24 lg:py-32 border-b border-white/5">
        <div className="container mx-auto px-4 md:px-6 max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 mb-12">
            ...
            return <div key={item.title} className="text-center p-6 rounded-lg hover:bg-white/[0.02] transition-all">
