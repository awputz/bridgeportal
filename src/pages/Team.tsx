...
const Team = () => {
  ...
  const { data, isLoading } = useBridgeAgents();
    ...
    <div className="min-h-screen pt-24 md:pt-32 lg:pt-40 pb-16 md:pb-24 lg:pb-32 px-4 md:px-6 lg:px-8">
      <div className="container mx-auto max-w-7xl">
        ...
        <section className="mb-16 md:mb-24 lg:mb-32">
          <h2 className="text-xl md:text-2xl lg:text-3xl font-light mb-8 md:mb-12 text-center">Collective Credentials</h2>
          <TeamPerformance />
        </section>

        {/* Our Network */}
        <section className="mb-12 md:mb-16 lg:mb-20">
          <h2 className="text-xl md:text-2xl lg:text-3xl font-light mb-6 md:mb-10 text-center">Our Network</h2>
          <p className="text-sm md:text-base text-muted-foreground font-light text-center mb-8 md:mb-12 max-w-3xl mx-auto">
