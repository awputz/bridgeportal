    ...
    return (
      <div className="mb-24 md:mb-32 lg:mb-40">
        <div className="flex items-center gap-4 mb-14 md:mb-16 lg:mb-20">
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-light">{CATEGORY_LABELS[category]}</h2>
          <div className="h-px flex-1 bg-border" />
        </div>
        
        <div className={`grid ${isLeadership ? 'grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8' : 'grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5 md:gap-6'} stagger-reveal`}>
