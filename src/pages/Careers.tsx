...
const whyBridgeValues = [{
  icon: TrendingUp,
  title: "Growth",
  desc: "Clear career paths with mentorship from senior leadership."
}, {
  icon: Users,
  title: "Culture",
  desc: "Collaborative environment where wins are celebrated."
}, {
  icon: Award,
  title: "Compensation",
  desc: "Industry-leading commission structures and benefits."
}, {
  icon: Shield,
  title: "Integrity",
  desc: "Transparency and honest communication in everything."
}, {
  icon: Zap,
  title: "Speed",
  ...
  return <div className="min-h-screen">
      ...
      <section className="py-10 sm:py-12 md:py-20 border-b border-white/5" ref={positionsReveal.elementRef}>
        <div className="container mx-auto px-4 md:px-6 max-w-4xl">
          <div className={`transition-all duration-700 ${positionsReveal.isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <div className="space-y-3 sm:space-y-4">
              {openPositions.map((position, index) => <div key={position.title} className="p-3 sm:p-4 md:p-5 rounded-lg border border-white/10 bg-white/[0.02] hover:bg-white/[0.04] transition-colors" style={{
      ...
      <section className="py-12 md:py-20 border-b border-white/5 bg-white/[0.01]" ref={whyBridgeReveal.elementRef}>
        <div className="container mx-auto px-4 md:px-6 max-w-5xl">
          <div className={`transition-all duration-700 ${whyBridgeReveal.isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 sm:gap-3 md:gap-4">
              ...
              return <div key={item.title} className="p-3 sm:p-4 rounded-lg border border-white/10 bg-white/[0.02] hover:bg-white/[0.04] transition-colors" style={{
                transitionDelay: `${index * 50}ms`
              }}>
      ...
      <section className="py-12 md:py-20 border-b border-white/5" ref={cultureReveal.elementRef}>
        <div className="container mx-auto px-4 md:px-6 max-w-6xl">
          <div className={`grid md:grid-cols-2 gap-12 items-center transition-all duration-700 ${cultureReveal.isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <div className="relative aspect-[4/3] rounded-lg overflow-hidden">
              <img src={PLACEHOLDER_IMAGES.office.teamWork} alt="Team collaboration at Bridge" className="w-full h-full object-cover grayscale hover:grayscale-0 transition-all duration-500" />
            </div>
            <div>
