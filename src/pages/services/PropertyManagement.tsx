  ...
  return <div className="min-h-screen">
      ...
      <section className="relative h-[45vh] md:h-[55vh] lg:h-[60vh] min-h-[320px] md:min-h-[400px] lg:min-h-[500px] flex items-center justify-center" ref={heroReveal.elementRef}>
        <div className="absolute inset-0 z-0">
          <img src={propertyManagementHeroImg} alt="New York City skyline" className="w-full h-full object-cover" />
          ...
          <div className={`grid md:grid-cols-2 gap-8 md:gap-12 items-start transition-all duration-700 ${servicesReveal.isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <div>
              ...
              <div className="grid gap-4">
                {services.map((service, index) => <div key={service.title} className="group p-4 rounded-lg border border-white/10 bg-white/[0.02] flex items-start gap-4 hover:bg-white/[0.05] hover:border-accent/30 transition-all duration-300" style={{
            ...
            <div className="relative aspect-[4/3] rounded-lg overflow-hidden">
              <img src={PLACEHOLDER_IMAGES.building.apartment} alt="Modern apartment interior" className="w-full h-full object-cover grayscale hover:grayscale-0 transition-all duration-500" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 md:px-6 max-w-5xl">
          <div className={`transition-all duration-700 ${marketsReveal.isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
              {markets.map((market, index) => <div key={market.borough} className="p-6 rounded-lg border border-white/10 bg-white/[0.02] hover:bg-white/[0.04] transition-all duration-300" style={{
