...
export default function PropertyManagement() {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero with Image */}
      <section
        className="relative min-h-[45vh] sm:min-h-[50vh] md:min-h-[50vh] lg:min-h-[55vh] flex items-center justify-center pt-24 sm:pt-28 md:pt-32 lg:pt-36 xl:pt-40 pb-8 sm:pb-10 md:pb-12 lg:pb-16 xl:pb-20"
