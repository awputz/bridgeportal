  ...
  return <div className="min-h-screen">
      ...
      <section className="py-12 md:py-20 lg:py-28 border-b border-white/5 bg-white/[0.01]" ref={debtReveal.elementRef}>
        <div className="container mx-auto px-4 md:px-6 max-w-6xl">
          <div className={`grid md:grid-cols-2 gap-12 items-start transition-all duration-700 ${debtReveal.isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <div>
              ...
              <div className="grid gap-6">
                <div className={`p-6 rounded-lg bg-white/[0.02] border border-white/5 transition-all duration-500 hover:border-accent/20 hover:bg-white/[0.04] ${debtReveal.isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`} style={{
      ...
      <section className="py-12 md:py-20 lg:py-28 border-b border-white/5" ref={equityReveal.elementRef}>
        <div className="container mx-auto px-4 md:px-6 max-w-6xl">
          <div className={`grid md:grid-cols-2 gap-12 items-start transition-all duration-700 ${equityReveal.isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <div className="order-1 md:order-2">
              ...
              <div className="grid gap-6">
                <div className={`p-6 rounded-lg bg-white/[0.02] border border-white/5 transition-all duration-500 hover:border-accent/20 hover:bg-white/[0.04] ${equityReveal.isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`} style={{
                transitionDelay: '100ms'
              }}>
                  <div className="flex items-center gap-3 mb-3">
      ...
      <section className="py-12 md:py-20 lg:py-28 border-b border-white/5 bg-white/[0.01]" ref={recapReveal.elementRef}>
        <div className="container mx-auto px-4 md:px-6 max-w-5xl">
          <div className={`transition-all duration-700 ${recapReveal.isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <div className="flex items-center gap-3 md:gap-4 mb-4 md:mb-6">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className={`p-6 rounded-lg bg-white/[0.02] border border-white/5 transition-all duration-500 hover:border-accent/20 hover:bg-white/[0.04] ${recapReveal.isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`} style={{
              transitionDelay: '100ms'
            }}>
      ...
      <section className="py-12 md:py-20 lg:py-28 border-b border-white/5" ref={calculatorReveal.elementRef}>
        <div className="container mx-auto px-4 md:px-6">
          <div className={`text-center mb-8 md:mb-12 transition-all duration-700 ${calculatorReveal.isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
      ...
      <section className="py-12 md:py-20 lg:py-28" ref={ctaReveal.elementRef}>
        <div className={`container mx-auto px-4 md:px-6 text-center transition-all duration-700 ${ctaReveal.isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
