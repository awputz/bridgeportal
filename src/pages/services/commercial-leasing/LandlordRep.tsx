  ...
  const heroContent = (
    <section className="relative bg-gradient-to-b from-secondary to-background pt-32 pb-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-6">Landlord Representation</h1>
        <p className="text-xl text-muted-foreground max-w-3xl">Maximize your property's value with strategic leasing and tenant curation.</p>
      </div>
    </section>
  );
