  ...
  const heroContent = (
    <section className="relative bg-gradient-to-b from-secondary to-background pt-32 pb-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-6">Retail Leasing</h1>
        <p className="text-xl text-muted-foreground max-w-3xl">Prime retail spaces in NYC's most desirable shopping corridors.</p>
      </div>
    </section>
  );
  ...
  return (
    <ServicePageLayout serviceKey="commercial-leasing" heroContent={heroContent}>
      <section className="py-20 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-foreground mb-8">Retail Corridors We Serve</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {["Fifth Avenue", "Madison Avenue", "SoHo", "Williamsburg", "Upper East Side", "Meatpacking District"].map(area => (
