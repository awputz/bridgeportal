  ...
  return <div className="min-h-screen">
      ...
      <section className="relative min-h-[45vh] sm:min-h-[50vh] md:min-h-[50vh] lg:min-h-[55vh] flex items-center justify-center pt-24 sm:pt-28 md:pt-32 lg:pt-36 xl:pt-40 pb-8 sm:pb-10 md:pb-12 lg:pb-16 xl:pb-20">
        ...
        <div className="container mx-auto px-4 md:px-6 max-w-4xl text-center relative z-10">
          ...
          <div className="flex flex-col gap-3 max-w-md mx-auto animate-fade-in" style={{
          ...
          <a href="https://streeteasy.com/profile/957575-bridge-advisory-group?tab_profile=active_listings" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-accent hover:text-accent/80 font-light transition-colors animate-fade-in text-sm md:text-base mt-4 sm:mt-5" style={{
      ...
      <section className="py-12 md:py-20 lg:py-28 border-b border-white/5" ref={marketsReveal.elementRef}>
        <div className="container mx-auto px-4 md:px-6 max-w-5xl">
          <div className={`transition-all duration-700 ${marketsReveal.isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
            ...
            <SwipeHint text="Scroll to explore neighborhoods" direction="vertical" storageKey="residential-markets" />
          </div>
        </div>
      </section>
      ...
      <section className="py-12 md:py-20 lg:py-28 border-b border-white/5 bg-white/[0.01]" ref={portfolioReveal.elementRef}>
        <div className="container mx-auto px-4 md:px-6 max-w-6xl">
          <div className={`transition-all duration-700 ${portfolioReveal.isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
            ...
            <SwipeHint text="Tap to learn more" storageKey="residential-portfolio" className="mt-4" />
